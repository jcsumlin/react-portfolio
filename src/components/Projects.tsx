...
const featuredProject: Project | undefined = projectsData.find(project => project.featured);
const projects: Project[] = projectsData.filter(project => !project.featured);

export default function Projects() {

    return (
        <div className="mt-4 min-h-screen px-4 md:px-8 py-16 bg-[#222831]" id="projects">
            ...
            {featuredProject && (
                <div className="mb-16">
                    <h3 className="text-sm uppercase tracking-wider text-cyan-300 mb-4">Featured Project</h3>
                    <div className="bg-[#2D3440] rounded-lg shadow-xl overflow-hidden border border-gray-700 hover:shadow-2xl hover:border-cyan-700 transition-all duration-300 transform hover:-translate-y-1">
                        <div className="md:flex">
                            ...
                            <div className="p-8 md:w-1/2">
                                <h2 className="text-2xl font-bold mb-4 text-white">{featuredProject.title}</h2>
            ...
            {/* Other Projects Grid */}
            <div>
                <h3 className="text-sm uppercase tracking-wider text-cyan-300 mb-6">Other Projects</h3>
