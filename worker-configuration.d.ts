/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6152459685a43f80b8dba98d2b43cccf)
// Runtime types generated with workerd@1.20251011.0 2025-04-03 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
	}
	interface Env {
		TO_EMAIL: "chat@chatsumlin.com";
		FROM_EMAIL: "No Reply <send@chatsumlin.com>";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TO_EMAIL" | "FROM_EMAIL" | "VITE_HCAPTCHA_SITE_KEY" | "RESEND_API_KEY">> {}
}
